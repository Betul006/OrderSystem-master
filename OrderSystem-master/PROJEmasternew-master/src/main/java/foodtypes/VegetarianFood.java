...
public VegetarianFood(){
    ...
    public void foodName() {
        ...
        System.out.println("Choose your food type ( cauliflower / rice  / sarma / spinach / soup):");
        String food1 = scanner.nextLine().toLowerCase().trim();
        while (true) {
            if (food1.equals("cauliflower") || food1.equals("rice") ||
                    food1.equals("sarma") || food1.equals("spinach") ||
                    food1.equals("soup")) {
    ...
    public void writingToFoodFile() {
        ...
        try {
            FileWriter fw = new FileWriter("PROJEmasternew-master/src/main/java/com/ravzakoc/file/order_food.txt", true);
            fw.write(
